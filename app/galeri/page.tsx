    ...
    <main className="min-h-screen relative bg-transparent">
      <div className="relative z-10">
        ...
        <section className="pt-32 pb-12 px-4">
          ...
          >
            <div className="relative w-full max-w-[600px] h-[300px] md:h-[450px] mx-auto flex items-center justify-center -mt-20 -mb-16 md:-mt-40 md:-mb-28">
              <Image
                ...
                priority
              />
              <h1 className="relative z-10 text-5xl md:text-6xl font-serif font-bold text-foreground pb-4">Galeri</h1>
            </div>
            <p className="text-xl text-muted-foreground font-light italic max-w-2xl mx-auto -mt-2">
            ...
            >
              {images.map((item, index) => (
                <motion.div
                  key={item.id}
                  variants={fadeIn}
                  className={`relative aspect-square overflow-hidden rounded-[2.5rem] group cursor-pointer shadow-lg shadow-stone-200/50 transition-all duration-500 bg-white ease-out ${hoveredImageIndex === index
                    ? "z-10 scale-90 brightness-110"
                    : hoveredImageIndex !== null
                      ? "brightness-40 grayscale-[0.3]"
                      : "hover:shadow-xl"
                    }`}
